...
public class FleetManagement {
	...
	private void planRoutes() {
		...
		RouteNode additionalNode = this.routePlanner.addRouteNode( new RouteNode("X"));
	...
	private void initCarriers() {
		...
		for (Carrier c : carriers) {
			// NOTE: this is VERY bad style and NOT OO, my use VISITOR-PATTERN instead: double dynamic binding
